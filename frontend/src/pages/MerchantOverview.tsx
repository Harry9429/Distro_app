...
export default function MerchantOverview() {
  return (
    <div className="content-area merchant-overview">
      <h2 className="section-title text-2xl font-semibold text-gray-900">Merchant Dashboard</h2>

      {/* Stats Grid – merchant-focused */}
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <Link to="/orders/view/4573" className="view-request-button">
              ...
              <tr>
                ...
                <td>
                  <Link to="/orders/view/4724" className="view-request-button">
                    View Request <span aria-hidden="true">▼</span>
                  </Link>
                </td>
                <td>Sherry</td>
              ...
              <tr>
                ...
                <td>
                  <Link to="/orders/view/4773" className="view-request-button">
                    View Request <span aria-hidden="true">▼</span>
                  </Link>
                </td>
                <td>Areeba</td>
